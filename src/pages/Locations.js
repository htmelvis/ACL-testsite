		...
		<div className="mt-8 location-list">
			<div className="mt-2 mb-2 location-accordion">
				<div className="location-title mb-2">
					<h1 className="uppercase pb-3 border-b-2 border-blue-200 mb-4"><a onClick={(e) => setOpenAccordion(e,'erie')}>Erie County ACL PSC Location Addresses &amp; Hours <strong>{openAccordion === 'erie' ? '-' : '+'}</strong></a></h1>
				</div>
				{openAccordion === 'erie' &&
				<div className="location-content">
					<div className="flex flex-wrap justify-between items-center">
						{erieLocations.map((location, i) => (
							<div key={i} className="w-1--3 address text-center mb-4 mt-2 mx-0">
								<h3 className="font-bold text-blue-600"><a href="#">{location.name}</a></h3>
								<p className="leading-tight mt-0 mb-0">{location.add1}<br/>
									{location.add2} <br/>
									{location.add3 && location.add3}</p>
								<p className="leading-none mt-2 mb-0">Phone: <a href={`tel:${location.phone}`}>{location.phone}</a></p>
								<p className="leading-none mt-2 mb-0">Fax: {location.phone}</p>
								<div className="location-hours">
									<p onClick={(e) => showHours(e, i) } className="font-bold mt-3 text-sm hours-title">VIEW HOURS { hoursShown === i ? '-' : '+'}</p>
									{hoursShown === i && <div className="hours">
										<p className="leading-none mt-2 mb-0"><span className="text-sm font-bold text-blue-800">Monday - Friday:</span> <br /> {location.hours.mf}</p>
										<p className="leading-none mt-2 mb-0"><span className="text-sm font-bold text-blue-800">Saturday:</span> <br /> {location.hours.sat}</p>
										<p className="leading-none mt-2 mb-0"><span className="text-sm font-bold text-blue-800">Sunday:</span> <br /> {location.hours.sun}</p>
									</div>}
								</div>
								{/*{*/}
			...
			<div className="mt-6 mb-2 location-accordion">
				<div className="location-title mb-2">
					<h1 className="uppercase pb-3 border-b-2 border-blue-200 mb-4"><a onClick={(e) => setOpenAccordion(e,'new-york')}>New York ACL PSC Location Addresses &amp; Hours <strong>{openAccordion === 'new-york' ? '-' : '+'}</strong></a></h1>
				</div>
			...
			<div className="mt-6 mb-2 location-accordion">
				<div className="location-title mb-2">
					<h1 className="uppercase pb-3 border-b-2 border-blue-200 mb-4"><a onClick={(e) => setOpenAccordion(e,'other')}>Other ACL PSC Location Addresses &amp; Hours <strong>{openAccordion === 'other' ? '-' : '+'}</strong></a></h1>
				</div>
				{openAccordion === 'other' &&
				<div className="location-content">
